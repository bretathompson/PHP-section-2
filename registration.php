...
// Setting Language varables

if(isset($GET['lang']) && !empty($_GET['lang'])){
...
?>
    ...
    <form method="get" class="navbar-form navbar-right action="" id="language_form">
     ...
     <select name="lang" class="form-control" onchange="changeLanguage()" >
        <option value="en"<?php if(isset($SESSION['lang']) == 'en'){echo "selected";} ?>>English/option>
        <option value="es"<?php if(isset($SESSION['lang']) == 'es'){echo "selected";} ?>>Spanish/option>
       </select>
     </div>
</form>
